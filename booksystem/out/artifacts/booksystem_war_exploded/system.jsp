...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"7","icon":"","menuname":"图书管理",
							"menus":[
									{"menuid":"71","menuname":"分类列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
                                {"menuid":"72","menuname":"图书列表","icon":"icon-book-open","url":"SelectedCourseServlet?method=toSelectedCourseListView"},
                            ]
						},
						{"menuid":"8","icon":"","menuname":"借阅管理",
							"menus":[
									{"menuid":"81","menuname":"借阅列表","icon":"icon-book-open","url":"AttendanceServlet?method=toAttendanceServletListView"},
								]
						},
						{"menuid":"9","icon":"","menuname":"借阅统计",
							"menus":[
									{"menuid":"91","menuname":"统计图表","icon":"icon-book-open","url":"LeaveServlet?method=toLeaveServletListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">图书管理系统</span>
    </div>
