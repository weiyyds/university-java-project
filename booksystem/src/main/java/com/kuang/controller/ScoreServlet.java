...
import com.kuang.dao.CourseDao;
import com.kuang.dao.ScoreDao;
import com.kuang.dao.SelectedCourseDao;
import com.kuang.dao.StudentDao;
import com.kuang.entity.Course;
import com.kuang.entity.Page;
import com.kuang.entity.Score;
...
public class ScoreServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException{
        ...
        if("toScoreListView".equals(method)){
            ...
            try {
                request.getRequestDispatcher("scoreStats.jsp").forward(request, response);
            } catch (ServletException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
