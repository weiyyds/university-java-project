...
<table class="table table-bordered table-hover definewidth m10" >
   ...
   <c:forEach items="${doctorList }" var="doctor">
        ...
        <td>
        	...
        	<c:if test="${doctor.department == 6 }">牙诊</c:if>
        </td>
        <td>操作</td>
    </tr>
   </c:forEach>
  ...
  <table class="table table-bordered table-hover definewidth m10" >
  	<tr>
          ...
          <a href='${path }doctor?method=findDoctorByPage&currentPage=1' >首页</a> 
          
          <a href='${path }doctor?method=findDoctorByPage&currentPage=${pageTool.prePage}'>上一页</a>
          
          <a href='${path }doctor?method=findDoctorByPage&currentPage=${pageTool.nextPage}'>下一页</a> 
          
          <a href='${path }doctor?method=findDoctorByPage&currentPage=${pageTool.totalPages}'>尾页</a>
